...
const STATIC_PAGES: PageDef[] = [
  ...
  { path: "/guides", priority: 0.88, changeFrequency: "weekly" },
  { path: "/guides/how-to-beat-extreme-ai", priority: 0.85, changeFrequency: "monthly" },
  { path: "/guides/fast-castle-guide", priority: 0.85, changeFrequency: "monthly" },
  { path: "/guides/unit-counters-guide", priority: 0.85, changeFrequency: "monthly" },
  { path: "/guides/how-to-climb-elo", priority: 0.85, changeFrequency: "monthly" },
