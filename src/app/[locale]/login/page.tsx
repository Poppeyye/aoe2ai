    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="card max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-medieval font-bold gold-gradient mb-2">
            {d.signed_in_as}
          </h1>
          ...
          >
            <LogOut className="w-4 h-4" /> {d.signout}
          </button>
          <Link
            href={`/${locale}`}
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="card max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-2">{d.subtitle}</p>
        </div>
        ...
        {hasProviders ? (
          ...
          <p className="text-center text-gray-500 text-sm">{d.no_providers}</p>
        )}
